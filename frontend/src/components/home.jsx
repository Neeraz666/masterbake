        ...
        <div>
            ...
            <div className="menu-container">
                <div className="gallery">
                    ...
                    <div className="productlist">
                        <img src="./images/cheesepizza.jpeg" alt="" />
                            <h3>Cheese pizza</h3>
                            <h6>$16.00</h6>
                            <ul>
                                <li>
            ...
            <div className="offers" style={{ paddingTop: '0px' }}>
                <div className="flyer">
                    <img className="img" src="./images/offer1.png" alt="" />
                        <img className="img" src="./images/offer2.png" alt="" />
                            <img className="img" src="./images/offer3.png" alt="" />
                            </div>
                        </div>
                        ...
                        <div className="caption">
                            <div className="picture">
                                <img className="caption-img" src="./images/chef.png" alt="" />
                            </div>
